...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained("path/to/standard_DNABERT2/", trust_remote_code=True)
    model = AutoModel.from_pretrained("path/to/standard_DNABERT2/", trust_remote_code=True)

    txt_file_path = "TESTNAME_std.oseq.txt"
    dna_sequences = load_dna_sequences_from_txt(txt_file_path)
    output_csv_file_path = "DNABERT2_TESTNAME_std.oseq.csv"

...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained("standard_DNABERT2/", trust_remote_code=True)
    model = AutoModel.from_pretrained("standard_DNABERT2/", trust_remote_code=True)

    txt_file_path = "UpstreamAll_1000shuf_upper.txt"
    dna_sequences = load_dna_sequences_from_txt(txt_file_path)
    output_csv_file_path = "UpstreamAll_1000shuf_embedding.csv"
